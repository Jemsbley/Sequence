...
/**
 * Same as the FarsightedOffensiveNetworkBuilding, but will now block opponent sequences when
 * possible and save 2EJs for finalizing sequences of its own.
 */
public class FarsightedOffensiveSavingNetworkBuilding implements SequenceAlgorithm {
