...
/**
 * Same as OffensiveNetworkBuilding, but will consider the other cards in the player's hand in
 * addition to those on the board
 */
public class FarsightedOffensiveNetworkBuilding implements SequenceAlgorithm {
